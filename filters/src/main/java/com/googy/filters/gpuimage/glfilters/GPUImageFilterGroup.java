...
import com.googy.filters.gpuimage.util.TextureRotationUtil;
...
import static com.googy.filters.gpuimage.glfilters.GPUImageRenderer.CUBE;
import static com.googy.filters.gpuimage.util.TextureRotationUtil.TEXTURE_NO_ROTATION;
...
public class GPUImageFilterGroup extends GPUImageFilter {
    ...
    public void addFilters(List<GPUImageFilter> aFilters) {
        if (aFilters == null) {
            return;
        }
        mFilters.addAll(aFilters);
        updateMergedFilters();
    }
