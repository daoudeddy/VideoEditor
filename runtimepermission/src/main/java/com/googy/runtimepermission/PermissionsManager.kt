package com.googy.runtimepermission

import android.content.Context
import android.util.Log
import androidx.appcompat.app.AppCompatActivity
import androidx.fragment.app.Fragment
import com.googy.runtimepermission.util.PermissionCheckerFragment
import com.googy.runtimepermission.util.PermissionsUtil
import com.googy.runtimepermission.util.QuickPermissionsOptions
import com.googy.runtimepermission.util.QuickPermissionsRequest
    ...
    if (target is AppCompatActivity || target is Fragment) {
        ...
        if (PermissionsUtil.hasSelfPermission(context, arrayOf(*permissions))) {
            ...
            permissionRequest.permanentlyDeniedMessage =
                if (options.permanentlyDeniedMessage.isBlank())
