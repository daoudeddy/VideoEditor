...
public class OverlayView extends View {
    ...
    {
        mTouchPointThreshold = getResources().getDimensionPixelSize(R.dimen.default_crop_rect_corner_touch_threshold);
        mCropRectMinSize = getResources().getDimensionPixelSize(R.dimen.default_crop_rect_min_size);
        mCropRectCornerTouchAreaLineLength = getResources().getDimensionPixelSize(R.dimen.default_crop_rect_corner_touch_area_line_length);
    }
...
//        }
    ...
    protected void processStyledAttributes(@NonNull TypedArray a) {
        ...
        mDimmedColor = a.getColor(R.styleable.UCropView_dimmed_color, getResources().getColor(R.color.color_default_dimmed));
    ...
    private void initCropFrameStyle(@NonNull TypedArray a) {
        int cropFrameStrokeSize = a.getDimensionPixelSize(R.styleable.UCropView_frame_stroke_size, getResources().getDimensionPixelSize(R.dimen.default_crop_frame_stoke_width));
        int cropFrameColor = a.getColor(R.styleable.UCropView_frame_color, getResources().getColor(R.color.color_default_crop_frame));
    ...
    private void initCropGridStyle(@NonNull TypedArray a) {
        int cropGridStrokeSize = a.getDimensionPixelSize(R.styleable.UCropView_grid_stroke_size,
                getResources().getDimensionPixelSize(R.dimen.default_crop_grid_stoke_width));
        int cropGridColor = a.getColor(R.styleable.UCropView_grid_color,
                getResources().getColor(R.color.color_default_crop_grid));
