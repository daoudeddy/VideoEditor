...
public class HorizontalProgressWheelView extends View {
    ...
    private void init() {
        mMiddleLineColor = ContextCompat.getColor(getContext(), R.color.white);

        mProgressLineWidth = getContext().getResources().getDimensionPixelSize(R.dimen.width_horizontal_wheel_progress_line);
        mProgressLineHeight = getContext().getResources().getDimensionPixelSize(R.dimen.height_horizontal_wheel_progress_line);
        mProgressLineMargin = getContext().getResources().getDimensionPixelSize(R.dimen.margin_horizontal_wheel_progress_line);
        ...
        mProgressMiddleLinePaint.setStrokeWidth(getContext().getResources().getDimensionPixelSize(R.dimen.width_middle_wheel_progress_line));
    }
